  ...
  var e,
    t = {
      1213: function (e, t, n) {
        ...
        function b(e) {
          var t = m((0, i.useState)(e.default), 2),
            ...
            r = t[1];
          function a(t) {
            r(t), "function" == typeof e.onSelect && e.onSelect(t);
          }
          return i.createElement(
            "div",
            ...
            (function (t) {
              for (var n = [], r = 0; r < e.items.length; )
                e.hideOptionOnSelect
                  ? e.items[r].id !== t && n.push(i.createElement(y, { key: e.items[r].id, id: e.items[r].id, label: e.items[r].label, selected: e.items[r].id === t, onSelect: a }))
                  : n.push(i.createElement(y, { key: e.items[r].id, id: e.items[r].id, label: e.items[r].label, selected: e.items[r].id === t, onSelect: a })),
                  (r += 1);
              return n;
            })(n)
          );
        ...
        function v(e) {
          ...
          return (
            ...
            i.createElement(
              "div",
              { ref: n, className: "media-filter" },
              i.createElement(
                u,
                { contentRef: l },
                i.createElement(
                  "button",
                  { className: "popup-trigger", "aria-label": "Filter" },
                  i.createElement("span", { className: "filter-button-label" }, i.createElement("span", { className: "filter-button-label-text" }, d), i.createElement(o.MaterialIcon, { type: "arrow_drop_down" }))
                )
              ),
              i.createElement(
                s,
                { contentRef: l },
                i.createElement("div", { className: "main-options" }, i.createElement(o.PopupMain, null, i.createElement(b, { items: e.options, default: r, onSelect: a, hideOptionOnSelect: e.hideOptionOnSelect })))
              )
            )
          );
        }
        function g(e) {
          ...
          return (
            (0, i.useEffect)(
              function () {
                l.current.tryToHide(), "function" == typeof e.onSelect && e.onSelect(r);
              },
              [r]
            ),
            i.createElement(
              ...
              i.createElement(
                ...
                i.createElement(
                  "button",
                  { className: "popup-trigger", "aria-label": "Filter" },
                  i.createElement(o.MaterialIcon, { type: "sort" }),
                  i.createElement("span", { className: "filter-button-label" }, i.createElement("span", { className: "filter-button-label-text" }, e.label))
                )
              ),
              i.createElement(s, { contentRef: l }, i.createElement("div", { className: "main-options" }, i.createElement(o.PopupMain, null, i.createElement(b, { items: e.options, default: r, onSelect: a }))))
            )
          );
        }
        var E = [
          ...
          O = [
            { id: "date_added_desc", label: "Upload date (newest)" },
            { id: "date_added_asc", label: "Upload date (oldest)" },
            { id: "most_views", label: "View count" },
            { id: "most_likes", label: "Like count" },
          ];
        function w(e) {
          var t = m((0, i.useState)("all"), 2),
            ...
            l = a[0],
            o = a[1],
            s = m((0, i.useState)({ sort_by: null, ordering: null, media_type: null }), 2),
            u = s[0],
            c = s[1];
          function f() {
            var e = d(d({}, u), {}, { media_type: null, sort_by: null, ordering: null });
            switch (n) {
              case "video":
                e.media_type = "video";
                break;
            ...
            switch (l) {
              case "most_views":
                (e.sort_by = "views"), (e.ordering = null);
                break;
              case "most_likes":
                (e.sort_by = "likes"), (e.ordering = null);
                break;
              case "date_added_asc":
                (e.sort_by = null), (e.ordering = "asc");
            }
            c(e);
          }
          return (
        ...
        function N(e) {
          ...
          function g(t) {
            var n = { media_type: s, upload_date: f, sort_by: m };
            switch (t.currentTarget.getAttribute("filter")) {
              case "media_type":
                (n.media_type = t.currentTarget.getAttribute("value")), e.onFiltersUpdate(n), u(n.media_type);
                break;
              case "upload_date":
                (n.upload_date = t.currentTarget.getAttribute("value")), e.onFiltersUpdate(n), d(n.upload_date);
                break;
              case "sort_by":
                (n.sort_by = t.currentTarget.getAttribute("value")), e.onFiltersUpdate(n), h(n.sort_by);
            }
          }
          return (
            (0, i.useEffect)(
            ...
            (0, i.useEffect)(function () {
              return (
                l.PageStore.on("window_resize", v),
                function () {
            ...
            i.createElement(
              "div",
              { ref: y, className: "mi-filters-row" + (n ? " hidden" : "") },
              i.createElement(
                "div",
                { ref: b, className: "mi-filters-row-inner" },
                i.createElement(
                  "div",
                  { className: "mi-filter" },
                  i.createElement("div", { className: "mi-filter-title" }, "MEDIA TYPE"),
                  i.createElement("div", { className: "mi-filter-options" }, i.createElement(o.FilterOptions, { id: "media_type", options: A.media_type, selected: s, onSelect: g }))
                ),
                i.createElement(
                  "div",
                  { className: "mi-filter" },
                  i.createElement("div", { className: "mi-filter-title" }, "UPLOAD DATE"),
                  i.createElement("div", { className: "mi-filter-options" }, i.createElement(o.FilterOptions, { id: "upload_date", options: A.upload_date, selected: f, onSelect: g }))
                ),
                i.createElement(
                  "div",
                  { className: "mi-filter" },
                  i.createElement("div", { className: "mi-filter-title" }, "SORT BY"),
                  i.createElement("div", { className: "mi-filter-options" }, i.createElement(o.FilterOptions, { id: "sort_by", options: A.sort_by, selected: m, onSelect: g }))
                )
              )
            )
          );
        ...
        (N.propTypes = { hidden: k().bool }), (N.defaultProps = { hidden: !1 });
        var R = (function (e) {
          !(function (e, t) {
          ...
          return (
            ...
            (n = [
              ...
              },
              {
                key: "onFiltersUpdate",
                value: function (e) {
                  var t = { media_type: null, upload_date: null, sort_by: null, ordering: null };
                  switch (e.media_type) {
                    case "video":
                    case "audio":
                    case "image":
                  ...
                  var n = [];
                  for (var r in t) null !== t[r] && n.push(r + "=" + t[r]);
                  this.setState({ filterArgs: n.length ? "&" + n.join("&") : "" }, function () {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  null !== this.state.resultsCount &&
                    (e
                      ? this.state.searchCategories
                        ? ((t = null === this.state.resultsCount || 0 === this.state.resultsCount ? "No" : this.state.resultsCount), (t += ' media in category "' + this.state.searchCategories + '"'))
                        : this.state.searchTags
                        ? ((t = null === this.state.resultsCount || 0 === this.state.resultsCount ? "No" : this.state.resultsCount), (t += ' media in tag "' + this.state.searchTags + '"'))
                        : (t =
                            null === this.state.resultsCount || 0 === this.state.resultsCount
                              ? 'No results for "' + this.state.searchQuery + '"'
                              : this.state.resultsCount + " result" + (1 < this.state.resultsCount ? "s" : "") + ' for "' + this.state.searchQuery + '"')
                      : (t = 'No results for "' + this.state.searchQuery + '"'));
                  ...
                  this.didMount ? this.setState({ validQuery: e, requestUrl: r, resultsTitle: t }) : ((this.state.validQuery = e), (this.state.requestUrl = r), (this.state.resultsTitle = t));
                },
              },
              {
                ...
                value: function (e) {
                  var t = [];
                  for (var n in e) null !== e[n] && t.push(n + "=" + e[n]);
                  this.setState({ filterArgs: t.length ? "&" + t.join("&") : "" }, function () {
                    this.updateRequestUrl();
                  });
                },
              },
              {
                key: "getCountFunc",
                value: function (e) {
                  this.setState({ resultsCount: e }, function () {
                    this.updateRequestUrl();
                  });
                },
              },
              {
                ...
                value: function () {
                  ...
                  return i.createElement(
                    s.MediaListWrapper,
                    { className: "search-results-wrap items-list-hor", title: null === this.state.resultsTitle ? null : this.state.resultsTitle },
                    e ? i.createElement(o.FiltersToggleButton, { onClick: this.onToggleFiltersClick }) : null,
                    e ? i.createElement(N, { hidden: this.state.hiddenFilters, onFiltersUpdate: this.onFiltersUpdate }) : null,
                    e ? null : i.createElement(w, { onFiltersUpdate: this.onFilterArgsUpdate }),
                    this.state.validQuery
                      ? i.createElement(u.LazyLoadItemListAsync, {
        ...
        function y(e) {
          ...
          return (
            (0, r.useEffect)(function () {
              return (
                d(new c.g(e.pageItems, e.maxItems, e.firstItemRequestUrl, e.requestUrl, v, g)),
                function () {
            ...
            a
              ? o.length
                ? r.createElement(
                    ...
                    r.createElement(
                      "div",
                      { ref: y, className: "items-list-wrap" },
                      r.createElement(
                        "div",
                        { ref: b, className: p.list },
                        o.map(function (t, n) {
                          return r.createElement(u.H, m({ key: n }, (0, u.j)(e, t, n)));
                        })
                      )
                    ),
                    O()
                ...
                : null
              : r.createElement(s.K, { className: p.listOuter })
          );
        }
        (y.propTypes = d(d({}, o.s.propTypes), {}, { items: a().array, requestUrl: a().string.isRequired, firstItemRequestUrl: a().string })),
          (y.defaultProps = d(d({}, o.s.defaultProps), {}, { requestUrl: null, firstItemRequestUrl: null, pageItems: 24 }));
      },
      1450: function (e, t, n) {
        function r() {
          var e,
      ...
      1397: function (e, t, n) {
        ...
        function a(e, t) {
          var n = i()(e, {});
          return ("" !== n.origin && "null" !== n.origin && n.origin) || (n = i()(t + "/" + e.replace(/^\//g, ""), {})), n.toString();
        }
      },
      447: function (e, t, n) {
        n.d(t, {
                  ...
                  switch ((e.prev = e.next)) {
                    case 0:
                      if (
                        ...
                        (l = { timeout: null, maxContentLength: null }),
                        !n)
                      ) {
                        e.next = 8;
                        break;
        ...
        function c() {
          return (c = l(
            regeneratorRuntime.mark(function e(t, n, i, a, l, o) {
              var s, u;
              return regeneratorRuntime.wrap(function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
        ...
        function m() {
          return (m = l(
            regeneratorRuntime.mark(function e(t, n, r, a, l) {
              var o, s;
              return regeneratorRuntime.wrap(function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
        ...
        n(3804),
          (t.MediaListWrapper = function (e) {
            var t = e.title,
              ...
              o = e.style,
              s = e.children;
            return i.default.createElement("div", { className: (l ? l + " " : "") + "media-list-wrapper", style: o }, i.default.createElement(a.MediaListRow, { title: t, viewAllLink: n, viewAllText: r }, s || null));
          });
      },
    },
    n = {};
