!(function () {
  ...
  var e,
    t = {
      4254: function (e, t, n) {
        var r = n(2541),
          o = (n(3233), n(4458), n(5101), n(2004), n(8407), n(6394), n(4669), n(2322), n(9268), n(3080), n(8288), n(5677), n(2129), n(4655), n(5466)),
          i = n(3074),
          a = n.n(i),
          u = n(137),
          l = n.n(u),
        ...
        var j = (function (e) {
            ...
            function n(e) {
              ...
              return (
                g(this, n),
                ((r = t.call(this, e)).state = { subject: "", body: "", isSending: !1 }),
              ...
              k(n, [
                {
                  key: "onUpdateSubject",
                  value: function () {
                    this.setState({ subject: this.refs.msgSubject.value.trim() });
                  },
                },
                {
                  key: "onUpdateBody",
                  value: function () {
                    this.setState({ body: this.refs.msgBody.value.trim() });
                  },
                },
                {
                  key: "onSubmitSuccess",
                  value: function (e) {
                    this.setState({ subject: "", body: "", isSending: !1 }, function () {
                      setTimeout(
                        function () {
                ...
                },
                {
                  key: "onSubmitFail",
                  value: function (e) {
                    this.setState({ isSending: !1 }, function () {
                      b.log(e),
                        setTimeout(
                          function () {
                ...
                },
                {
                  ...
                  value: function (e) {
                    this.state.isSending ||
                      ...
                      (e.preventDefault(),
                      e.stopPropagation(),
                      this.setState({ isSending: !0 }, function () {
                        var e = c.ApiUrlContext._currentValue.users + "/" + this.props.author.username + "/contact";
                        (0, s.postRequest)(e, { subject: this.state.subject, body: this.state.body }, { headers: { "X-CSRFToken": (0, s.csrfToken)() } }, !1, this.onSubmitSuccess, this.onSubmitFail);
                      }));
                  },
                },
                {
                  ...
                  value: function () {
                    return o.createElement(
                      ...
                      o.createElement("div", { className: "media-list-header" }, o.createElement("h2", null, "Contact")),
                      o.createElement(
                        "form",
                        { method: "post", className: "user-contact-form" + (this.state.isSending ? " pending-response" : "") },
                        o.createElement("span", null, o.createElement("label", null, "Subject"), o.createElement("input", { ref: "msgSubject", type: "text", required: !0, onChange: this.onUpdateSubject, value: this.state.subject })),
                        o.createElement("span", null, o.createElement("label", null, "Message"), o.createElement("textarea", { ref: "msgBody", required: !0, cols: "40", rows: "10", onChange: this.onUpdateBody, value: this.state.body })),
                        o.createElement("button", { onClick: this.onSubmit }, "SUBMIT")
                      )
                    );
                  },
                },
          ...
          C = (function (e) {
            ...
            function n(e) {
              var r;
              return g(this, n), ((r = t.call(this, e, "author-about")).userIsAuthor = null), (r.enabledContactForm = !1), r;
            }
            return (
              k(n, [
                {
                  ...
                  value: function () {
                    ...
                    if (this.state.author) {
                      var r, i;
                      if (
                        (null === this.userIsAuthor &&
                          (c.MemberContext._currentValue.is.anonymous
                            ? ((this.userIsAuthor = !1), (this.enabledContactForm = !1))
                            : ((this.userIsAuthor = p.ProfilePageStore.get("author-data").username === c.MemberContext._currentValue.username),
                        ...
                        for (r = 0; r < this.state.author.location_info.length; )
                          void 0 !== this.state.author.location_info[r].title &&
                            void 0 !== this.state.author.location_info[r].url &&
                            a.push(
                              o.createElement(
                                "a",
                                { key: r, href: (0, s.formatInnerLink)(this.state.author.location_info[r].url, c.SiteContext._currentValue.url), title: this.state.author.location_info[r].title },
                                this.state.author.location_info[r].title
                              )
                            ),
                            (r += 1);
                        t.push(o.createElement("li", { key: "location" }, o.createElement("span", null, "Location:"), o.createElement("span", null, a)));
                      } else
                        void 0 !== this.state.author.location &&
                          this.state.author.location &&
                          "" !== this.state.author.location &&
                          t.push(o.createElement("li", { key: "location" }, o.createElement("span", null, "Location:"), o.createElement("span", null, this.state.author.location)));
                      if (
                        (void 0 !== this.state.author.home_page &&
                          this.state.author.home_page &&
                          "" !== this.state.author.home_page &&
                          "" !== (i = l()(this.state.author.home_page.trim()).toString()) &&
                          t.push(o.createElement("li", { key: "website" }, o.createElement("span", null, "Website:"), o.createElement("span", null, i))),
                        ...
                        if (u.length) {
                          for (r = 0; r < u.length; ) "" !== (i = u[r].trim()) && n.push(o.createElement("span", { key: r }, i)), (r += 1);
                          t.push(o.createElement("li", { key: "social_media" }, o.createElement("span", null, "Social media:"), o.createElement("span", { className: "author-social-media" }, n)));
                        }
                      }
                    }
                    return [
                      this.state.author ? o.createElement(m.Z, { key: "ProfilePagesHeader", author: this.state.author, type: "about" }) : null,
                      this.state.author
                        ? o.createElement(
                            d.Z,
                            { key: "ProfilePagesContent", enabledContactForm: this.enabledContactForm },
                            o.createElement(
                              "div",
                              { className: "media-list-wrapper items-list-ver  profile-about-content " },
                              null === e && 0 < t.length
                                ? null
                                : p.PageStore.get("config-options").pages.profile.htmlInDescription
                                ? o.createElement(h.MediaListRow, { title: this.props.title }, o.createElement("span", { dangerouslySetInnerHTML: { __html: e || null } }))
                                : o.createElement(h.MediaListRow, { title: this.props.title }, e),
                              t.length ? o.createElement(h.MediaListRow, { title: "Details" }, o.createElement("ul", { className: "profile-details" }, t)) : null,
                              this.enabledContactForm ? o.createElement(j, { author: this.state.author }) : null
                            )
                          )
                        : null,
                    ];
        ...
        (C.propTypes = { title: a().string.isRequired }), (C.defaultProps = { title: "Biography" }), (0, r.X)("page-profile-about", C);
      },
      7714: function (e, t, n) {
        n.d(t, {
          M: function () {
      ...
      2915: function (e, t, n) {
          ...
          return r.createElement(
            ...
            r.createElement(
              "button",
              {
                ...
                "aria-label": "Filter",
                onClick: function () {
                  l(!i), void 0 !== e.onClick && e.onClick();
                },
              },
        ...
        (l.propTypes = { onClick: i().func, active: i().bool }), (l.defaultProps = { active: !1 });
      },
      4234: function (e, t, n) {
        n.d(t, {
      ...
      2917: function (e, t, n) {
        ...
        function l(e) {
          ...
          function f(t, n) {
            var r;
            n.preventDefault(), n.stopPropagation(), (r = s[t].id), void 0 !== e.pages[r] && c(r);
          }
          return (
            (0, r.useEffect)(
              function () {
            ...
            l ? r.createElement("div", { ref: i }, r.cloneElement(e.pages[l])) : null
          );
        }
        (l.propTypes = { initPage: a().string, pages: a().object.isRequired, pageChangeSelector: a().string.isRequired, pageIdSelectorAttr: a().string.isRequired, focusFirstItemOnPageChange: a().bool, pageChangeCallback: a().func }),
          (l.defaultProps = { focusFirstItemOnPageChange: !0 });
      },
      5671: function (e, t, n) {
        n.d(t, {
          S: function () {
        ...
        function c(e) {
          var t = e.items.map(function (e, t) {
            return r.createElement(l, u({ key: t }, e));
          });
        ...
        (l.propTypes = {
          ...
          (l.defaultProps = { itemType: "link", iconPos: "left", active: !1 }),
          (c.propTypes = { removeVerticalPadding: i().bool, items: i().arrayOf(i().shape(l.propTypes)).isRequired }),
          (c.defaultProps = { removeVerticalPadding: !1 });
      },
      2436: function (e, t, n) {
        n.d(t, {
          T: function () {
          ...
          return (
            (0, r.useEffect)(function () {
              return (
                ...
                function () {
                  c && clearTimeout(c), s && clearTimeout(s);
                }
              );
            }, []),
            ...
            l
              ? r.createElement(
                  ...
                  r.createElement(
                    ...
                    (n = e.map(function (e) {
                      return c.push(e), r.createElement(s, { key: e[0], id: e[0], onHide: m }, e[1]);
                    })),
                    [].concat(i(t), i(n)))
                  ),
                  " "
      ...
      6142: function (e, t, n) {
        ...
        function c(e) {
          ...
          return r.createElement(u.M, n, t ? r.createElement("img", { src: t, alt: "" }) : r.createElement(l.O, { type: "person" }));
        }
        (c.propTypes = { isButton: i().bool, size: i().oneOf(["small", "medium", "large"]), onClick: i().func }), (c.defaultProps = { isButton: !1, size: "medium" });
      },
      6191: function (e, t, n) {
        n.d(t, {
          PageHeader: function () {
          ...
          v = (function (e) {
            ...
            function v(e) {
              ...
              return (
                ...
                (t = c.call(this)),
                (b = (0, l.v)(window.MediaCMS)),
                (r = new a.BrowserCache(b.site.id, 86400)),
                ((y = { mediaAutoPlay: r.get("media-auto-play") }).mediaAutoPlay = null === y.mediaAutoPlay || y.mediaAutoPlay),
                  ...
                  value: function (e) {
                    switch (e.type) {
                      ...
                      case "TOGGLE_AUTO_PLAY":
                        (y.mediaAutoPlay = !y.mediaAutoPlay), r.set("media-auto-play", y.mediaAutoPlay), this.emit("switched_media_auto_play");
                        break;
  ...
  (r.m = t),
    ...
    (function () {
      ...
      var t = function (t, n) {
          ...
          if (l) var s = l(r);
          for (t && t(n); c < a.length; c++) (i = a[c]), r.o(e, i) && e[i] && e[i][0](), (e[a[c]] = 0);
          return r.O(s);
        },
