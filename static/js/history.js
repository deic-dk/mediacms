  ...
  var e,
    t = {
      4638: function (e, t, n) {
        var r = n(2541),
          o = n(376);
        (0, r.X)("page-history", o.HistoryPage);
      },
      1567: function (e, t, n) {
        n.r(t),
          n.d(t, {
            ProfileHistoryPage: function () {
              return b;
            },
          }),
          n(5101),
        ...
        var b = (function (e) {
          ...
          function b(e) {
            ...
            return (
              ...
              ((t = y.call(this, e, "author-history")).state = { resultsCount: null }),
            ...
            (n = [
              ...
              },
              {
                ...
                value: function () {
                  var e = this;
                  return [
                    this.state.author ? r.createElement(s.Z, { key: "ProfilePagesHeader", author: this.state.author, type: "history" }) : null,
                    this.state.author
                      ? r.createElement(
                          c.Z,
                          ...
                          r.createElement(u.ApiUrlConsumer, null, function (t) {
                            return r.createElement(
                              ...
                              r.createElement(f.LazyLoadItemListAsync, {
                                itemsCountCallback: e.getCountFunc,
                                requestUrl: t.user.history,
        ...
        (b.propTypes = { title: i().string.isRequired }), (b.defaultProps = { title: "History" });
      },
      376: function (e, t, n) {
        var r =
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }), (t.HistoryPage = t.AnonymousHistoryPage = void 0);
        var u = i(n(5466)),
          a = n(3613),
          l = n(8578),
          s = n(2546),
          ...
          p = n(1567),
          d = n(7637);
        (t.AnonymousHistoryPage = function (e) {
          var t = e.id,
            n = void 0 === t ? "history-media" : t,
            r = e.title,
            o = void 0 === r ? l.PageStore.get("config-enabled").pages.history.title : r,
            i = u.useState(null),
            s = i[0],
            c = i[1];
          return u.default.createElement(
            ...
            u.default.createElement(a.ApiUrlConsumer, null, function (e) {
              return u.default.createElement(
                f.MediaListWrapper,
                { title: o + (null !== s ? " (" + s + ")" : ""), className: "search-results-wrap items-list-hor" },
                u.default.createElement(y.LazyLoadItemListAsync, {
                  singleLinkContent: !1,
                  horizontalItemsOrientation: !0,
                  itemsCountCallback: c,
                  requestUrl: e.user.history,
          ...
          (t.HistoryPage = function () {
            var e = s.useUser(),
              n = e.username,
              r = e.isAnonymous || !l.PageStore.get("config-options").pages.profile.includeHistory;
            return (
              r || (c.addClassname(document.getElementById("page-history"), "profile-page-history"), (window.MediaCMS.profileId = n)),
              r ? u.default.createElement(t.AnonymousHistoryPage, null) : u.default.createElement(p.ProfileHistoryPage, null)
            );
          });
      },
    },
  ...
  (r.m = t),
    ...
    (function () {
      ...
      var t = function (t, n) {
          ...
          if (l) var c = l(r);
          for (t && t(n); s < u.length; s++) (i = u[s]), r.o(e, i) && e[i] && e[i][0](), (e[u[s]] = 0);
          return r.O(c);
        },
