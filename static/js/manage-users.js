!(function () {
  ...
  var e,
    t = {
      7839: function (e, t, n) {
        var r = n(2541),
          o = (n(7441), n(5101), n(3080), n(2004), n(8407), n(6394), n(8288), n(5677), n(2129), n(4655), n(5466)),
          i = n(3074),
          a = n.n(i),
          l = n(3613),
          u = n(541),
        ...
        function g(e) {
          var t = d((0, o.useState)(e.hidden), 2),
            n = t[0],
            r = t[1],
            i = d((0, o.useState)("all"), 2),
            a = i[0],
            l = i[1],
            u = (0, o.useRef)(null),
            c = (0, o.useRef)(null);
          function p() {
            n || (u.current.style.height = 24 + c.current.offsetHeight + "px");
          }
          return (
            (0, o.useEffect)(
              function () {
            ...
            (0, o.useEffect)(function () {
              return (
                f.PageStore.on("window_resize", p),
                function () {
                  return f.PageStore.removeListener("window_resize", p);
                }
              );
            }, []),
            o.createElement(
              "div",
              { ref: u, className: "mi-filters-row" + (n ? " hidden" : "") },
              o.createElement(
                "div",
                { ref: c, className: "mi-filters-row-inner" },
                o.createElement(
                  "div",
                  { className: "mi-filter" },
                  o.createElement("div", { className: "mi-filter-title" }, "ROLE"),
                  o.createElement(
                    "div",
                    { className: "mi-filter-options" },
                    o.createElement(s.FilterOptions, {
                      id: "role",
                      options: m.role,
                      selected: a,
                      onSelect: function (t) {
                        ...
                        switch (t.currentTarget.getAttribute("filter")) {
                          case "role":
                            (n.role = t.currentTarget.getAttribute("value")), e.onFiltersUpdate(n), l(n.role);
                        }
                      },
                    })
                  )
        ...
        (g.propTypes = { hidden: a().bool }), (g.defaultProps = { hidden: !1 });
        var v = n(9700);
        function y(e) {
          return (y =
        ...
        var P = (function (e) {
          ...
          function f(e) {
            ...
            return (
              ...
              ((t = a.call(this, e, "manage-users")).state = {
                resultsCount: null,
                currentPage: 1,
                requestUrl: l.ApiUrlContext._currentValue.manage.users,
                hiddenFilters: !0,
                filterArgs: "",
                sortingArgs: "",
                sortBy: "add_date",
              ...
              (t.getCountFunc = t.getCountFunc.bind(k(t))),
              (t.onTablePageChange = t.onTablePageChange.bind(k(t))),
              (t.onToggleFiltersClick = t.onToggleFiltersClick.bind(k(t))),
              (t.onFiltersUpdate = t.onFiltersUpdate.bind(k(t))),
              (t.onColumnSortClick = t.onColumnSortClick.bind(k(t))),
              (t.onItemsRemoval = t.onItemsRemoval.bind(k(t))),
              (t.onItemsRemovalFail = t.onItemsRemovalFail.bind(k(t))),
              t
            );
          }
          return (
            ...
            (n = [
              {
                ...
                value: function (e, t) {
                  this.setState({ currentPage: t, requestUrl: E(l.ApiUrlContext._currentValue.manage.users, this.state.filterArgs, this.state.sortingArgs, t) });
                },
              },
              {
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  this.setState({ filterArgs: t.join("&"), requestUrl: E(l.ApiUrlContext._currentValue.manage.users, t.join("&"), this.state.sortingArgs, this.state.currentPage) });
                },
              },
              {
                ...
                value: function (e, t) {
                  ...
                  this.setState({ sortBy: e, ordering: t, sortingArgs: n, requestUrl: E(l.ApiUrlContext._currentValue.manage.users, this.state.filterArgs, n, this.state.currentPage) });
                },
              },
              {
                key: "onItemsRemoval",
                value: function (e) {
                  this.setState({ resultsCount: null, refresh: this.state.refresh + 1, requestUrl: l.ApiUrlContext._currentValue.manage.users }, function () {
                    e ? u.PageActions.addNotification("The users deleted successfully.", "usersRemovalSucceed") : u.PageActions.addNotification("The user deleted successfully.", "userRemovalSucceed");
                  });
                },
              },
              {
                ...
                value: function (e) {
                  e ? u.PageActions.addNotification("The users removal failed. Please try again.", "usersRemovalFailed") : u.PageActions.addNotification("The user removal failed. Please try again.", "userRemovalFailed");
                },
              },
              {
                key: "pageContent",
                value: function () {
                  return [
                    o.createElement(
                      c.MediaListWrapper,
                      { key: "2", title: this.props.title + (null === this.state.resultsCount ? "" : " (" + this.state.resultsCount + ")") },
                      o.createElement(s.FiltersToggleButton, { onClick: this.onToggleFiltersClick }),
                      o.createElement(g, { hidden: this.state.hiddenFilters, onFiltersUpdate: this.onFiltersUpdate }),
                      o.createElement(v.d, {
                        pageItems: 50,
                        manageType: "users",
        ...
        (P.propTypes = { title: a().string.isRequired }), (P.defaultProps = { title: "Manage users" }), (0, r.X)("page-manage-users", P);
      },
      7714: function (e, t, n) {
        n.d(t, {
          M: function () {
        ...
        (l.propTypes = { type: i().oneOf(["button", "link", "span"]), buttonShadow: i().bool, className: i().string }), (l.defaultProps = { type: "button", buttonShadow: !1 });
      },
      7446: function (e, t, n) {
        n.d(t, {
          j: function () {
        ...
        function l(e) {
          return e.options.map(function (t) {
            return r.createElement(
              ...
              r.createElement("button", { onClick: e.onSelect, filter: e.id, value: t.id }, r.createElement("span", null, t.title), t.id === e.selected ? r.createElement(a.O, { type: "close" }) : null)
            );
          });
        }
        l.propTypes = { id: i().string.isRequired, selected: i().string.isRequired, onSelect: i().func.isRequired };
      },
      2915: function (e, t, n) {
        n.d(t, {
          _: function () {
          ...
          return r.createElement(
            ...
            r.createElement(
              "button",
              {
                ...
                "aria-label": "Filter",
                onClick: function () {
                  u(!i), void 0 !== e.onClick && e.onClick();
                },
              },
        ...
        (u.propTypes = { onClick: i().func, active: i().bool }), (u.defaultProps = { active: !1 });
      },
      4234: function (e, t, n) {
        n.d(t, {
      ...
      2917: function (e, t, n) {
        ...
        function u(e) {
          ...
          function f(t, n) {
            var r;
            n.preventDefault(), n.stopPropagation(), (r = c[t].id), void 0 !== e.pages[r] && s(r);
          }
          return (
            (0, r.useEffect)(
              function () {
                void 0 !== e.pages[e.initPage] ? s(e.initPage) : Object.keys(e.pages).length ? s(Object.keys(e.pages)[0]) : s(null);
              },
              [e.initPage]
            ),
            (0, r.useEffect)(
              function () {
                !(function () {
                  ...
                  u &&
                    ...
                    "function" == typeof e.pageChangeCallback && e.pageChangeCallback(u));
              },
              [u]
            ),
            u ? r.createElement("div", { ref: i }, r.cloneElement(e.pages[u])) : null
          );
        }
        (u.propTypes = { initPage: a().string, pages: a().object.isRequired, pageChangeSelector: a().string.isRequired, pageIdSelectorAttr: a().string.isRequired, focusFirstItemOnPageChange: a().bool, pageChangeCallback: a().func }),
          (u.defaultProps = { focusFirstItemOnPageChange: !0 });
      },
      5671: function (e, t, n) {
        n.d(t, {
          S: function () {
        ...
        function s(e) {
          var t = e.items.map(function (e, t) {
            return r.createElement(u, l({ key: t }, e));
          });
        ...
        (u.propTypes = {
          ...
          (u.defaultProps = { itemType: "link", iconPos: "left", active: !1 }),
          (s.propTypes = { removeVerticalPadding: i().bool, items: i().arrayOf(i().shape(u.propTypes)).isRequired }),
          (s.defaultProps = { removeVerticalPadding: !1 });
      },
      940: function (e, t, n) {
        n.d(t, {
          HF: function () {
  ...
  (r.m = t),
    ...
    (function () {
      ...
      var t = function (t, n) {
          ...
          if (u) var c = u(r);
          for (t && t(n); s < a.length; s++) (i = a[s]), r.o(e, i) && e[i] && e[i][0](), (e[a[s]] = 0);
          return r.O(c);
        },
